...
public class Paths { //C:\Users\ignac\Downloads\hotelstayplus\hotelstayplus\src\main\resources\FXML\login.fxml
    ...
    public synchronized static FXMLLoader getFXML(ClientMenuOptions pathEnum, Class<?> cl) {
        switch(pathEnum) {
            ...
            case ADMINDASHBOARD:
                return new FXMLLoader(cl.getResource(fxmlPath + "Admin/adminDashboard.fxml"));
            case ADMINBOOKINGS:
                return new FXMLLoader(cl.getResource(fxmlPath + "Admin/adminBookings.fxml"));
            case ADMINHOTELS:
                return new FXMLLoader(cl.getResource(fxmlPath + "Admin/adminHotels.fxml"));
            default:
                break;
